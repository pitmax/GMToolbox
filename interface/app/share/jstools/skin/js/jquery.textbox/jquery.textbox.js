 ...
 * MODIF PA : pour compatibilite jQuery 1.4.2
 *
...
$.fn.textbox = function(options) 
{
    ...
    return this.each(function() 
    {
        ...
        if(!$.data(this,"textbox"))
        {
            ...
            // The drop down list
            // MODIF PA : width - 2 pour compenser le border
            var list = $("<ul class='textboxlist' />"
            ).insertAfter($t).width(width - 2).mousedown(function(e)
            {
                list.toggle();
                $t.val($(e.target).text());
            ...
            $(window).resize(function()
            {
                ...
                arrow.css("margin-left",((width)-16)+"px"
                ).css("margin-top","-18px");
